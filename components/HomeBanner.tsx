      ...
      <div className="space-y-5 relative top-24">
        ...
        {movie?.vote_average && (
          <div className="flex justify-start gap-8 items-center cursor-pointer">
            ...
            <p className="bg-yellow-600 rounded-full px-2.5 py-2.5 text-sm w-20 text-center">
              Action
            </p>
            <p className="bg-yellow-600 rounded-full px-2.5 py-2.5 text-sm w-20 text-center">
              Drama
        ...
        <button className="flex gap-3 bg-yellow-600 px-2.5 py-2.5 rounded-md items-center">
          <BsPlayFill />
          WATCH NOW
        </button>
      </div>
