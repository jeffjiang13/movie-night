        ...
        >
          ...
          <ul className="justify-between relative mt-[35px] mb-[0] after:absolute after:bottom-[-16px] after:block after:bg-[#cccccc] after:h-[1px] after:w-[100%]">
            <li className="flex flex-col text-[#818181] text-[0.9rem]">
              <span className="text-gray-400 font-semibold">2,073</span>
              Followers
            </li>
            <li className="flex flex-col text-[#818181] text-[0.9rem]">
              <span className="text-gray-400 font-semibold">652</span>Following
            </li>
            <li className="flex flex-col text-[#818181] text-[0.9rem]">
              <span className="text-gray-400 font-semibold">120,543</span>
              Attraction
            </li>
            <br />
            <br />
