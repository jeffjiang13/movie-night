              ...
              <Stack spacing={5}>
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  {movieDetails?.genres?.map((genre, index) => (
                    <Chip
                      ...
                      variant="filled"
                      sx={{
                        backgroundColor: "#BF8915", // Set the background color to yellow
                        color: "white", // Set the text color to primary
                      }}
                      key={index}
                ...
                <Stack direction="row" spacing={1}>
                  {session && validation && (
                    <>
                      {isLoading ? (
                        <div className="flex justify-center items-center text-3xl text-yellow-600 px-4 animate-spin">
                          <AiOutlineLoading3Quarters />
                        </div>
                      ) : (
                        <>
                          {isUserFavorite ? (
                            <motion.div
                              ...
                              whileTap={{ scale: 1.5 }}
                              className="flex justify-center items-center text-3xl text-yellow-600 px-4 cursor-pointer"
                              onClick={() => addFavorite()}
                            >
                              <AiFillHeart />
                            </motion.div>
                  ...
                  <button
                    className="flex gap-3 bg-yellow-600 px-2.5 py-2.5 rounded-md items-center"
                    onClick={() => addFavorite()}
                  >
                    <BsPlayFill />
                    WATCH NOW
